...
DESCRIPTION_TEMPLATE = """
    ...
    ****PAY ATTENTION TO THE RULES AND THE EXAMPLES BELOW BETWEEN THE ''' ''' , THEY'RE VERY IMPORTANT.****
    ...
    ###RULES###:
        ...
        *** IMPORTANT ***
        - #### CHECK THE DATA DOWN BELOW BEFORE YOU ANSWER ANYTHING PLEASE ABOUT PLACES, FOOD, HOTELS, AND PRICES IN GENERAL###
        ...
        - AND MOST IMPORTANTLY CHECK THE DATA SET DOWN BELOW TO KNOW WHAT PLACES YOU CAN WORK WITH AND WHAT QUESTIONS YOU CAN ASK THE USER 
          AND RETRIEVE DATA FROM IT, THE PRICES ARE ONLY FROM THE DATASET AND STICK TO IT.
        - IF THE EXPENSE INCLUDES FOOD AND SLEEPOVER THEN LET THE USER KNOW THAT
